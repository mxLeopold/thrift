...
public class TemplateUnitInfo implements org.apache.thrift.TBase<TemplateUnitInfo, TemplateUnitInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TemplateUnitInfo> {
  ...
  public TemplateUnitInfo setTemplateCode(int templateCode) {
    this.templateCode = templateCode;
    setTemplateCodeIsSet(true);
    return this;
  }
  ...
  public void unsetTemplateCode() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TEMPLATECODE_ISSET_ID);
  }

  /** Returns true if field templateCode is set (has been assigned a value) and false otherwise */
  public boolean isSetTemplateCode() {
    return EncodingUtils.testBit(__isset_bitfield, __TEMPLATECODE_ISSET_ID);
  }

  public void setTemplateCodeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TEMPLATECODE_ISSET_ID, value);
  }
  ...
  public boolean equals(TemplateUnitInfo that) {
    ...
    boolean this_present_templateCode = true;
    boolean that_present_templateCode = true;
    if (this_present_templateCode || that_present_templateCode) {
      if (!(this_present_templateCode && that_present_templateCode))
        return false;
      if (this.templateCode != that.templateCode)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_templateCode = true;
