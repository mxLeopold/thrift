...
public class TikuUserRecord implements org.apache.thrift.TBase<TikuUserRecord, TikuUserRecord._Fields>, java.io.Serializable, Cloneable, Comparable<TikuUserRecord> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TikuUserRecord");
  ...
  static {
    schemes.put(StandardScheme.class, new TikuUserRecordStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TikuUserRecordTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TikuUserRecord.class, metaDataMap);
  }

  public TikuUserRecord() {
  }
   ...
   */
  public TikuUserRecord(TikuUserRecord other) {
    __isset_bitfield = other.__isset_bitfield;
    this.stuId = other.stuId;
    this.recordId = other.recordId;
  }

  public TikuUserRecord deepCopy() {
    return new TikuUserRecord(this);
  }
  ...
  public TikuUserRecord setStuId(int stuId) {
    this.stuId = stuId;
    setStuIdIsSet(true);
    return this;
  }
  ...
  public TikuUserRecord setRecordId(int recordId) {
    this.recordId = recordId;
    setRecordIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TikuUserRecord)
      return this.equals((TikuUserRecord)that);
    return false;
  }

  public boolean equals(TikuUserRecord that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TikuUserRecord other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TikuUserRecord(");
    boolean first = true;
  ...
  private static class TikuUserRecordStandardSchemeFactory implements SchemeFactory {
    public TikuUserRecordStandardScheme getScheme() {
      return new TikuUserRecordStandardScheme();
    }
  }

  private static class TikuUserRecordStandardScheme extends StandardScheme<TikuUserRecord> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TikuUserRecord struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TikuUserRecord struct) throws TException {
      struct.validate();
  ...
  private static class TikuUserRecordTupleSchemeFactory implements SchemeFactory {
    public TikuUserRecordTupleScheme getScheme() {
      return new TikuUserRecordTupleScheme();
    }
  }

  private static class TikuUserRecordTupleScheme extends TupleScheme<TikuUserRecord> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TikuUserRecord struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TikuUserRecord struct) throws TException {
