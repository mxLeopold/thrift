...
public class CourseTemplateUnit implements org.apache.thrift.TBase<CourseTemplateUnit, CourseTemplateUnit._Fields>, java.io.Serializable, Cloneable, Comparable<CourseTemplateUnit> {
  ...
  private static final org.apache.thrift.protocol.TField KNOWLEDGE_NODE_ID_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("knowledgeNodeIdList", org.apache.thrift.protocol.TType.LIST, (short)3);
  private static final org.apache.thrift.protocol.TField QUIZ_PAPER_CODE_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("quizPaperCodeList", org.apache.thrift.protocol.TType.LIST, (short)4);
  private static final org.apache.thrift.protocol.TField ASSIGNMENT_PAPER_CODE_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("assignmentPaperCodeList", org.apache.thrift.protocol.TType.LIST, (short)5);
  private static final org.apache.thrift.protocol.TField FILE_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("fileList", org.apache.thrift.protocol.TType.LIST, (short)6);
  ...
  public List<Integer> knowledgeNodeIdList; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    KNOWLEDGE_NODE_ID_LIST((short)3, "knowledgeNodeIdList"),
    QUIZ_PAPER_CODE_LIST((short)4, "quizPaperCodeList"),
    ASSIGNMENT_PAPER_CODE_LIST((short)5, "assignmentPaperCodeList"),
    FILE_LIST((short)6, "fileList");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // KNOWLEDGE_NODE_ID_LIST
          return KNOWLEDGE_NODE_ID_LIST;
        case 4: // QUIZ_PAPER_CODE_LIST
          return QUIZ_PAPER_CODE_LIST;
        case 5: // ASSIGNMENT_PAPER_CODE_LIST
  ...
  static {
    ...
    tmpMap.put(_Fields.TEMPLATE_UNIT_ID, new org.apache.thrift.meta_data.FieldMetaData("templateUnitId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.KNOWLEDGE_NODE_ID_LIST, new org.apache.thrift.meta_data.FieldMetaData("knowledgeNodeIdList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public CourseTemplateUnit(
    ...
    int templateUnitId,
    List<Integer> knowledgeNodeIdList,
    ...
    List<CourseTemplateUnitFile> fileList)
  {
    ...
    this.knowledgeNodeIdList = knowledgeNodeIdList;
  ...
  public CourseTemplateUnit(CourseTemplateUnit other) {
    ...
    if (other.isSetKnowledgeNodeIdList()) {
      List<Integer> __this__knowledgeNodeIdList = new ArrayList<Integer>(other.knowledgeNodeIdList);
      this.knowledgeNodeIdList = __this__knowledgeNodeIdList;
    }
  ...
  public int getKnowledgeNodeIdListSize() {
    return (this.knowledgeNodeIdList == null) ? 0 : this.knowledgeNodeIdList.size();
  }

  public java.util.Iterator<Integer> getKnowledgeNodeIdListIterator() {
    return (this.knowledgeNodeIdList == null) ? null : this.knowledgeNodeIdList.iterator();
  }

  public void addToKnowledgeNodeIdList(int elem) {
    if (this.knowledgeNodeIdList == null) {
      this.knowledgeNodeIdList = new ArrayList<Integer>();
    }
    this.knowledgeNodeIdList.add(elem);
  }

  public List<Integer> getKnowledgeNodeIdList() {
    return this.knowledgeNodeIdList;
  }

  public CourseTemplateUnit setKnowledgeNodeIdList(List<Integer> knowledgeNodeIdList) {
    this.knowledgeNodeIdList = knowledgeNodeIdList;
    return this;
  }

  public void unsetKnowledgeNodeIdList() {
    this.knowledgeNodeIdList = null;
  }

  /** Returns true if field knowledgeNodeIdList is set (has been assigned a value) and false otherwise */
  public boolean isSetKnowledgeNodeIdList() {
    return this.knowledgeNodeIdList != null;
  }

  public void setKnowledgeNodeIdListIsSet(boolean value) {
    if (!value) {
      this.knowledgeNodeIdList = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case KNOWLEDGE_NODE_ID_LIST:
      if (value == null) {
        unsetKnowledgeNodeIdList();
      } else {
        setKnowledgeNodeIdList((List<Integer>)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case KNOWLEDGE_NODE_ID_LIST:
      return isSetKnowledgeNodeIdList();
    case QUIZ_PAPER_CODE_LIST:
  ...
  public boolean equals(CourseTemplateUnit that) {
    ...
    boolean this_present_knowledgeNodeIdList = true && this.isSetKnowledgeNodeIdList();
    boolean that_present_knowledgeNodeIdList = true && that.isSetKnowledgeNodeIdList();
    if (this_present_knowledgeNodeIdList || that_present_knowledgeNodeIdList) {
      if (!(this_present_knowledgeNodeIdList && that_present_knowledgeNodeIdList))
        return false;
      if (!this.knowledgeNodeIdList.equals(that.knowledgeNodeIdList))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_knowledgeNodeIdList = true && (isSetKnowledgeNodeIdList());
    list.add(present_knowledgeNodeIdList);
    if (present_knowledgeNodeIdList)
      list.add(knowledgeNodeIdList);
  ...
  public int compareTo(CourseTemplateUnit other) {
    ...
    lastComparison = Boolean.valueOf(isSetKnowledgeNodeIdList()).compareTo(other.isSetKnowledgeNodeIdList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetKnowledgeNodeIdList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.knowledgeNodeIdList, other.knowledgeNodeIdList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("knowledgeNodeIdList:");
    if (this.knowledgeNodeIdList == null) {
      sb.append("null");
    } else {
      sb.append(this.knowledgeNodeIdList);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class CourseTemplateUnitStandardScheme extends StandardScheme<CourseTemplateUnit> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.knowledgeNodeIdList = new ArrayList<Integer>(_list0.size);
                int _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readI32();
                  struct.knowledgeNodeIdList.add(_elem1);
                }
                iprot.readListEnd();
              }
              struct.setKnowledgeNodeIdListIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CourseTemplateUnit struct) throws TException {
      ...
      oprot.writeFieldEnd();
      if (struct.knowledgeNodeIdList != null) {
        oprot.writeFieldBegin(KNOWLEDGE_NODE_ID_LIST_FIELD_DESC);
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, struct.knowledgeNodeIdList.size()));
          for (int _iter12 : struct.knowledgeNodeIdList)
          {
  ...
  private static class CourseTemplateUnitTupleScheme extends TupleScheme<CourseTemplateUnit> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, CourseTemplateUnit struct) throws TException {
      ...
      if (struct.isSetKnowledgeNodeIdList()) {
        optionals.set(2);
      }
      ...
      if (struct.isSetKnowledgeNodeIdList()) {
        {
          oprot.writeI32(struct.knowledgeNodeIdList.size());
          for (int _iter16 : struct.knowledgeNodeIdList)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.knowledgeNodeIdList = new ArrayList<Integer>(_list20.size);
          int _elem21;
          for (int _i22 = 0; _i22 < _list20.size; ++_i22)
          {
            _elem21 = iprot.readI32();
            struct.knowledgeNodeIdList.add(_elem21);
          }
        }
        struct.setKnowledgeNodeIdListIsSet(true);
      }
