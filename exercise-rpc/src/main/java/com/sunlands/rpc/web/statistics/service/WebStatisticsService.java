...
public class WebStatisticsService {
  ...
  public interface AsyncIface {
    ...
    public void getPaperStudentCorrectRate(UnitReportCondition unitReportCondition, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<QuizzesOrWorkUserCorrectRate> getPaperStudentCorrectRate(UnitReportCondition unitReportCondition) throws TException
    {
      send_getPaperStudentCorrectRate(unitReportCondition);
      return recv_getPaperStudentCorrectRate();
    }

    public void send_getPaperStudentCorrectRate(UnitReportCondition unitReportCondition) throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getPaperStudentCorrectRate(UnitReportCondition unitReportCondition, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      getPaperStudentCorrectRate_call method_call = new getPaperStudentCorrectRate_call(unitReportCondition, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getPaperStudentCorrectRate_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public getPaperStudentCorrectRate_call(UnitReportCondition unitReportCondition, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getPaperStudentCorrectRate<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPaperStudentCorrectRate_args> {
      ...
      public getPaperStudentCorrectRate_result getResult(I iface, getPaperStudentCorrectRate_args args) throws TException {
        getPaperStudentCorrectRate_result result = new getPaperStudentCorrectRate_result();
        result.success = iface.getPaperStudentCorrectRate(args.unitReportCondition);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getPaperStudentCorrectRate<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPaperStudentCorrectRate_args, List<QuizzesOrWorkUserCorrectRate>> {
      ...
      public void start(I iface, getPaperStudentCorrectRate_args args, AsyncMethodCallback<List<QuizzesOrWorkUserCorrectRate>> resultHandler) throws TException {
        iface.getPaperStudentCorrectRate(args.unitReportCondition,resultHandler);
      }
    }
    ...
    private static class getPaperStudentCorrectRate_resultStandardScheme extends StandardScheme<getPaperStudentCorrectRate_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<QuizzesOrWorkUserCorrectRate>(_list80.size);
                  QuizzesOrWorkUserCorrectRate _elem81;
                  for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                  {
                    _elem81 = new QuizzesOrWorkUserCorrectRate();
                    _elem81.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPaperStudentCorrectRate_result struct) throws TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (QuizzesOrWorkUserCorrectRate _iter83 : struct.success)
            {
              _iter83.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getPaperStudentCorrectRate_resultTupleScheme extends TupleScheme<getPaperStudentCorrectRate_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getPaperStudentCorrectRate_result struct) throws TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (QuizzesOrWorkUserCorrectRate _iter84 : struct.success)
            {
              _iter84.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<QuizzesOrWorkUserCorrectRate>(_list85.size);
            QuizzesOrWorkUserCorrectRate _elem86;
            for (int _i87 = 0; _i87 < _list85.size; ++_i87)
            {
              _elem86 = new QuizzesOrWorkUserCorrectRate();
              _elem86.read(iprot);
