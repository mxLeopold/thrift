              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<WorkPaperReport>(_list56.size);
                  WorkPaperReport _elem57;
                  for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                  {
                    _elem57 = new WorkPaperReport();
                    _elem57.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPaperReport_result struct) throws TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (WorkPaperReport _iter59 : struct.success)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (WorkPaperReport _iter60 : struct.success)
            {
              _iter60.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<WorkPaperReport>(_list61.size);
            WorkPaperReport _elem62;
            for (int _i63 = 0; _i63 < _list61.size; ++_i63)
            {
              _elem62 = new WorkPaperReport();
              _elem62.read(iprot);
