...
public class WebStatisticsService {
  ...
  public interface Iface {
    ...
    public Map<String,UnitsCorrectRateStatistic> retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds(List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition) throws TException;
  ...
  public interface AsyncIface {
    ...
    public void retrieveQuizzesAndAssignmentsByUnitIds(UnitsStatisticCondition unitsStatisticCondition, AsyncMethodCallback resultHandler) throws TException;
    ...
    public void retrieveQuizzesAndAssignmentsCorrectRateByUnitIds(UnitsStatisticCorrectRateCondition unitsStatisticCorrectRateCondition, AsyncMethodCallback resultHandler) throws TException;

    public void retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds(List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public UnitsStatistic retrieveQuizzesAndAssignmentsByUnitIds(UnitsStatisticCondition unitsStatisticCondition) throws TException
    {
      send_retrieveQuizzesAndAssignmentsByUnitIds(unitsStatisticCondition);
      return recv_retrieveQuizzesAndAssignmentsByUnitIds();
    }

    public void send_retrieveQuizzesAndAssignmentsByUnitIds(UnitsStatisticCondition unitsStatisticCondition) throws TException
    {
      retrieveQuizzesAndAssignmentsByUnitIds_args args = new retrieveQuizzesAndAssignmentsByUnitIds_args();
      args.setUnitsStatisticCondition(unitsStatisticCondition);
    ...
    public UnitsCorrectRateStatistic retrieveQuizzesAndAssignmentsCorrectRateByUnitIds(UnitsStatisticCorrectRateCondition unitsStatisticCorrectRateCondition) throws TException
    {
      send_retrieveQuizzesAndAssignmentsCorrectRateByUnitIds(unitsStatisticCorrectRateCondition);
      return recv_retrieveQuizzesAndAssignmentsCorrectRateByUnitIds();
    }

    public void send_retrieveQuizzesAndAssignmentsCorrectRateByUnitIds(UnitsStatisticCorrectRateCondition unitsStatisticCorrectRateCondition) throws TException
    {
      retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args args = new retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args();
      args.setUnitsStatisticCorrectRateCondition(unitsStatisticCorrectRateCondition);
    ...
    public Map<String,UnitsCorrectRateStatistic> retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds(List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition) throws TException
    {
      send_retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds(unitsStatisticCorrectRateCondition);
      return recv_retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds();
    }

    public void send_retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds(List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition) throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void retrieveQuizzesAndAssignmentsByUnitIds(UnitsStatisticCondition unitsStatisticCondition, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      retrieveQuizzesAndAssignmentsByUnitIds_call method_call = new retrieveQuizzesAndAssignmentsByUnitIds_call(unitsStatisticCondition, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class retrieveQuizzesAndAssignmentsByUnitIds_call extends org.apache.thrift.async.TAsyncMethodCall {
      private UnitsStatisticCondition unitsStatisticCondition;
      public retrieveQuizzesAndAssignmentsByUnitIds_call(UnitsStatisticCondition unitsStatisticCondition, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.unitsStatisticCondition = unitsStatisticCondition;
      }
    ...
    public void retrieveQuizzesAndAssignmentsCorrectRateByUnitIds(UnitsStatisticCorrectRateCondition unitsStatisticCorrectRateCondition, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_call method_call = new retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_call(unitsStatisticCorrectRateCondition, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_call extends org.apache.thrift.async.TAsyncMethodCall {
      private UnitsStatisticCorrectRateCondition unitsStatisticCorrectRateCondition;
      public retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_call(UnitsStatisticCorrectRateCondition unitsStatisticCorrectRateCondition, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.unitsStatisticCorrectRateCondition = unitsStatisticCorrectRateCondition;
      }
    ...
    public void retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds(List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_call method_call = new retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_call(unitsStatisticCorrectRateCondition, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_call extends org.apache.thrift.async.TAsyncMethodCall {
      private List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition;
      public retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_call(List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.unitsStatisticCorrectRateCondition = unitsStatisticCorrectRateCondition;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class retrieveQuizzesAndAssignmentsByUnitIds<I extends Iface> extends org.apache.thrift.ProcessFunction<I, retrieveQuizzesAndAssignmentsByUnitIds_args> {
      ...
      public retrieveQuizzesAndAssignmentsByUnitIds_result getResult(I iface, retrieveQuizzesAndAssignmentsByUnitIds_args args) throws TException {
        retrieveQuizzesAndAssignmentsByUnitIds_result result = new retrieveQuizzesAndAssignmentsByUnitIds_result();
        result.success = iface.retrieveQuizzesAndAssignmentsByUnitIds(args.unitsStatisticCondition);
        return result;
      }
    }
    ...
    public static class retrieveQuizzesAndAssignmentsCorrectRateByUnitIds<I extends Iface> extends org.apache.thrift.ProcessFunction<I, retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args> {
      ...
      public retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_result getResult(I iface, retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args args) throws TException {
        retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_result result = new retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_result();
        result.success = iface.retrieveQuizzesAndAssignmentsCorrectRateByUnitIds(args.unitsStatisticCorrectRateCondition);
        return result;
      }
    }
    ...
    public static class retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds<I extends Iface> extends org.apache.thrift.ProcessFunction<I, retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args> {
      ...
      public retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_result getResult(I iface, retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args args) throws TException {
        retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_result result = new retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_result();
        result.success = iface.retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds(args.unitsStatisticCorrectRateCondition);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class retrieveQuizzesAndAssignmentsByUnitIds<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, retrieveQuizzesAndAssignmentsByUnitIds_args, UnitsStatistic> {
      ...
      public void start(I iface, retrieveQuizzesAndAssignmentsByUnitIds_args args, AsyncMethodCallback<UnitsStatistic> resultHandler) throws TException {
        iface.retrieveQuizzesAndAssignmentsByUnitIds(args.unitsStatisticCondition,resultHandler);
      }
    }
    ...
    public static class retrieveQuizzesAndAssignmentsCorrectRateByUnitIds<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args, UnitsCorrectRateStatistic> {
      ...
      public void start(I iface, retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args args, AsyncMethodCallback<UnitsCorrectRateStatistic> resultHandler) throws TException {
        iface.retrieveQuizzesAndAssignmentsCorrectRateByUnitIds(args.unitsStatisticCorrectRateCondition,resultHandler);
      }
    }
    ...
    public static class retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args, Map<String,UnitsCorrectRateStatistic>> {
      ...
      public void start(I iface, retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args args, AsyncMethodCallback<Map<String,UnitsCorrectRateStatistic>> resultHandler) throws TException {
        iface.retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds(args.unitsStatisticCorrectRateCondition,resultHandler);
      }
    }
  ...
  public static class retrieveQuizzesAndAssignmentsByUnitIds_args implements org.apache.thrift.TBase<retrieveQuizzesAndAssignmentsByUnitIds_args, retrieveQuizzesAndAssignmentsByUnitIds_args._Fields>, java.io.Serializable, Cloneable, Comparable<retrieveQuizzesAndAssignmentsByUnitIds_args>   {
    ...
    private static final org.apache.thrift.protocol.TField UNITS_STATISTIC_CONDITION_FIELD_DESC = new org.apache.thrift.protocol.TField("unitsStatisticCondition", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public UnitsStatisticCondition unitsStatisticCondition; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      UNITS_STATISTIC_CONDITION((short)1, "unitsStatisticCondition");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // UNITS_STATISTIC_CONDITION
            return UNITS_STATISTIC_CONDITION;
          default:
            return null;
        }
      }
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.UNITS_STATISTIC_CONDITION, new org.apache.thrift.meta_data.FieldMetaData("unitsStatisticCondition", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public retrieveQuizzesAndAssignmentsByUnitIds_args(
      UnitsStatisticCondition unitsStatisticCondition)
    {
      this();
      this.unitsStatisticCondition = unitsStatisticCondition;
    }
    ...
    public retrieveQuizzesAndAssignmentsByUnitIds_args(retrieveQuizzesAndAssignmentsByUnitIds_args other) {
      if (other.isSetUnitsStatisticCondition()) {
        this.unitsStatisticCondition = new UnitsStatisticCondition(other.unitsStatisticCondition);
      }
    }
    ...
    @Override
    public void clear() {
      this.unitsStatisticCondition = null;
    }

    public UnitsStatisticCondition getUnitsStatisticCondition() {
      return this.unitsStatisticCondition;
    }

    public retrieveQuizzesAndAssignmentsByUnitIds_args setUnitsStatisticCondition(UnitsStatisticCondition unitsStatisticCondition) {
      this.unitsStatisticCondition = unitsStatisticCondition;
      return this;
    }

    public void unsetUnitsStatisticCondition() {
      this.unitsStatisticCondition = null;
    }

    /** Returns true if field unitsStatisticCondition is set (has been assigned a value) and false otherwise */
    public boolean isSetUnitsStatisticCondition() {
      return this.unitsStatisticCondition != null;
    }

    public void setUnitsStatisticConditionIsSet(boolean value) {
      if (!value) {
        this.unitsStatisticCondition = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      switch (field) {
      case UNITS_STATISTIC_CONDITION:
        if (value == null) {
          unsetUnitsStatisticCondition();
        } else {
          setUnitsStatisticCondition((UnitsStatisticCondition)value);
        }
        break;
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case UNITS_STATISTIC_CONDITION:
        return getUnitsStatisticCondition();
    ...
    public boolean isSet(_Fields field) {
      ...
      switch (field) {
      case UNITS_STATISTIC_CONDITION:
        return isSetUnitsStatisticCondition();
      }
      throw new IllegalStateException();
    }
    ...
    public boolean equals(retrieveQuizzesAndAssignmentsByUnitIds_args that) {
      ...
      boolean this_present_unitsStatisticCondition = true && this.isSetUnitsStatisticCondition();
      boolean that_present_unitsStatisticCondition = true && that.isSetUnitsStatisticCondition();
      if (this_present_unitsStatisticCondition || that_present_unitsStatisticCondition) {
        if (!(this_present_unitsStatisticCondition && that_present_unitsStatisticCondition))
          return false;
        if (!this.unitsStatisticCondition.equals(that.unitsStatisticCondition))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_unitsStatisticCondition = true && (isSetUnitsStatisticCondition());
      list.add(present_unitsStatisticCondition);
      if (present_unitsStatisticCondition)
        list.add(unitsStatisticCondition);
    ...
    public int compareTo(retrieveQuizzesAndAssignmentsByUnitIds_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetUnitsStatisticCondition()).compareTo(other.isSetUnitsStatisticCondition());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetUnitsStatisticCondition()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.unitsStatisticCondition, other.unitsStatisticCondition);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("unitsStatisticCondition:");
      if (this.unitsStatisticCondition == null) {
        sb.append("null");
      } else {
        sb.append(this.unitsStatisticCondition);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    public void validate() throws TException {
      // check for required fields
      // check for sub-struct validity
      if (unitsStatisticCondition != null) {
        unitsStatisticCondition.validate();
      }
    }
    ...
    private static class retrieveQuizzesAndAssignmentsByUnitIds_argsStandardScheme extends StandardScheme<retrieveQuizzesAndAssignmentsByUnitIds_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, retrieveQuizzesAndAssignmentsByUnitIds_args struct) throws TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // UNITS_STATISTIC_CONDITION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.unitsStatisticCondition = new UnitsStatisticCondition();
                struct.unitsStatisticCondition.read(iprot);
                struct.setUnitsStatisticConditionIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, retrieveQuizzesAndAssignmentsByUnitIds_args struct) throws TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.unitsStatisticCondition != null) {
          oprot.writeFieldBegin(UNITS_STATISTIC_CONDITION_FIELD_DESC);
          struct.unitsStatisticCondition.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
    ...
    private static class retrieveQuizzesAndAssignmentsByUnitIds_argsTupleScheme extends TupleScheme<retrieveQuizzesAndAssignmentsByUnitIds_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, retrieveQuizzesAndAssignmentsByUnitIds_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetUnitsStatisticCondition()) {
          optionals.set(0);
        }
        oprot.writeBitSet(optionals, 1);
        if (struct.isSetUnitsStatisticCondition()) {
  ...
  public static class retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args implements org.apache.thrift.TBase<retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args, retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args._Fields>, java.io.Serializable, Cloneable, Comparable<retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args>   {
    ...
    private static final org.apache.thrift.protocol.TField UNITS_STATISTIC_CORRECT_RATE_CONDITION_FIELD_DESC = new org.apache.thrift.protocol.TField("unitsStatisticCorrectRateCondition", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public UnitsStatisticCorrectRateCondition unitsStatisticCorrectRateCondition; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      UNITS_STATISTIC_CORRECT_RATE_CONDITION((short)1, "unitsStatisticCorrectRateCondition");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // UNITS_STATISTIC_CORRECT_RATE_CONDITION
            return UNITS_STATISTIC_CORRECT_RATE_CONDITION;
          default:
            return null;
        }
      }
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.UNITS_STATISTIC_CORRECT_RATE_CONDITION, new org.apache.thrift.meta_data.FieldMetaData("unitsStatisticCorrectRateCondition", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, UnitsStatisticCorrectRateCondition.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args(
      UnitsStatisticCorrectRateCondition unitsStatisticCorrectRateCondition)
    {
      this();
      this.unitsStatisticCorrectRateCondition = unitsStatisticCorrectRateCondition;
    }
    ...
    public retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args(retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args other) {
      if (other.isSetUnitsStatisticCorrectRateCondition()) {
        this.unitsStatisticCorrectRateCondition = new UnitsStatisticCorrectRateCondition(other.unitsStatisticCorrectRateCondition);
      }
    }
    ...
    @Override
    public void clear() {
      this.unitsStatisticCorrectRateCondition = null;
    }

    public UnitsStatisticCorrectRateCondition getUnitsStatisticCorrectRateCondition() {
      return this.unitsStatisticCorrectRateCondition;
    }

    public retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args setUnitsStatisticCorrectRateCondition(UnitsStatisticCorrectRateCondition unitsStatisticCorrectRateCondition) {
      this.unitsStatisticCorrectRateCondition = unitsStatisticCorrectRateCondition;
      return this;
    }

    public void unsetUnitsStatisticCorrectRateCondition() {
      this.unitsStatisticCorrectRateCondition = null;
    }

    /** Returns true if field unitsStatisticCorrectRateCondition is set (has been assigned a value) and false otherwise */
    public boolean isSetUnitsStatisticCorrectRateCondition() {
      return this.unitsStatisticCorrectRateCondition != null;
    }

    public void setUnitsStatisticCorrectRateConditionIsSet(boolean value) {
      if (!value) {
        this.unitsStatisticCorrectRateCondition = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      switch (field) {
      case UNITS_STATISTIC_CORRECT_RATE_CONDITION:
        if (value == null) {
          unsetUnitsStatisticCorrectRateCondition();
        } else {
          setUnitsStatisticCorrectRateCondition((UnitsStatisticCorrectRateCondition)value);
        }
        break;
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case UNITS_STATISTIC_CORRECT_RATE_CONDITION:
        return getUnitsStatisticCorrectRateCondition();
    ...
    public boolean isSet(_Fields field) {
      ...
      switch (field) {
      case UNITS_STATISTIC_CORRECT_RATE_CONDITION:
        return isSetUnitsStatisticCorrectRateCondition();
      }
      throw new IllegalStateException();
    }
    ...
    public boolean equals(retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args that) {
      ...
      boolean this_present_unitsStatisticCorrectRateCondition = true && this.isSetUnitsStatisticCorrectRateCondition();
      boolean that_present_unitsStatisticCorrectRateCondition = true && that.isSetUnitsStatisticCorrectRateCondition();
      if (this_present_unitsStatisticCorrectRateCondition || that_present_unitsStatisticCorrectRateCondition) {
        if (!(this_present_unitsStatisticCorrectRateCondition && that_present_unitsStatisticCorrectRateCondition))
          return false;
        if (!this.unitsStatisticCorrectRateCondition.equals(that.unitsStatisticCorrectRateCondition))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_unitsStatisticCorrectRateCondition = true && (isSetUnitsStatisticCorrectRateCondition());
      list.add(present_unitsStatisticCorrectRateCondition);
      if (present_unitsStatisticCorrectRateCondition)
        list.add(unitsStatisticCorrectRateCondition);
    ...
    public int compareTo(retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetUnitsStatisticCorrectRateCondition()).compareTo(other.isSetUnitsStatisticCorrectRateCondition());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetUnitsStatisticCorrectRateCondition()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.unitsStatisticCorrectRateCondition, other.unitsStatisticCorrectRateCondition);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("unitsStatisticCorrectRateCondition:");
      if (this.unitsStatisticCorrectRateCondition == null) {
        sb.append("null");
      } else {
        sb.append(this.unitsStatisticCorrectRateCondition);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    public void validate() throws TException {
      // check for required fields
      // check for sub-struct validity
      if (unitsStatisticCorrectRateCondition != null) {
        unitsStatisticCorrectRateCondition.validate();
      }
    }
    ...
    private static class retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_argsStandardScheme extends StandardScheme<retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args struct) throws TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // UNITS_STATISTIC_CORRECT_RATE_CONDITION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.unitsStatisticCorrectRateCondition = new UnitsStatisticCorrectRateCondition();
                struct.unitsStatisticCorrectRateCondition.read(iprot);
                struct.setUnitsStatisticCorrectRateConditionIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args struct) throws TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.unitsStatisticCorrectRateCondition != null) {
          oprot.writeFieldBegin(UNITS_STATISTIC_CORRECT_RATE_CONDITION_FIELD_DESC);
          struct.unitsStatisticCorrectRateCondition.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
    ...
    private static class retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_argsTupleScheme extends TupleScheme<retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, retrieveQuizzesAndAssignmentsCorrectRateByUnitIds_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetUnitsStatisticCorrectRateCondition()) {
          optionals.set(0);
        }
        oprot.writeBitSet(optionals, 1);
        if (struct.isSetUnitsStatisticCorrectRateCondition()) {
  ...
  public static class retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args implements org.apache.thrift.TBase<retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args, retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args._Fields>, java.io.Serializable, Cloneable, Comparable<retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args>   {
    ...
    private static final org.apache.thrift.protocol.TField UNITS_STATISTIC_CORRECT_RATE_CONDITION_FIELD_DESC = new org.apache.thrift.protocol.TField("unitsStatisticCorrectRateCondition", org.apache.thrift.protocol.TType.LIST, (short)1);
    ...
    public List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition; // required
    ...
    public retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args(
      List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition)
    {
      this();
      this.unitsStatisticCorrectRateCondition = unitsStatisticCorrectRateCondition;
    }
    ...
    public retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args(retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args other) {
      if (other.isSetUnitsStatisticCorrectRateCondition()) {
        List<UnitsStatisticCorrectRateCondition> __this__unitsStatisticCorrectRateCondition = new ArrayList<UnitsStatisticCorrectRateCondition>(other.unitsStatisticCorrectRateCondition.size());
        for (UnitsStatisticCorrectRateCondition other_element : other.unitsStatisticCorrectRateCondition) {
          __this__unitsStatisticCorrectRateCondition.add(new UnitsStatisticCorrectRateCondition(other_element));
        }
        this.unitsStatisticCorrectRateCondition = __this__unitsStatisticCorrectRateCondition;
      }
    }
    ...
    public int getUnitsStatisticCorrectRateConditionSize() {
      return (this.unitsStatisticCorrectRateCondition == null) ? 0 : this.unitsStatisticCorrectRateCondition.size();
    }

    public java.util.Iterator<UnitsStatisticCorrectRateCondition> getUnitsStatisticCorrectRateConditionIterator() {
      return (this.unitsStatisticCorrectRateCondition == null) ? null : this.unitsStatisticCorrectRateCondition.iterator();
    }

    public void addToUnitsStatisticCorrectRateCondition(UnitsStatisticCorrectRateCondition elem) {
      if (this.unitsStatisticCorrectRateCondition == null) {
        this.unitsStatisticCorrectRateCondition = new ArrayList<UnitsStatisticCorrectRateCondition>();
      }
      this.unitsStatisticCorrectRateCondition.add(elem);
    }

    public List<UnitsStatisticCorrectRateCondition> getUnitsStatisticCorrectRateCondition() {
      return this.unitsStatisticCorrectRateCondition;
    }

    public retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args setUnitsStatisticCorrectRateCondition(List<UnitsStatisticCorrectRateCondition> unitsStatisticCorrectRateCondition) {
      this.unitsStatisticCorrectRateCondition = unitsStatisticCorrectRateCondition;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case UNITS_STATISTIC_CORRECT_RATE_CONDITION:
        if (value == null) {
          ...
          setUnitsStatisticCorrectRateCondition((List<UnitsStatisticCorrectRateCondition>)value);
        }
        break;
    ...
    private static class retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_argsStandardScheme extends StandardScheme<retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.unitsStatisticCorrectRateCondition = new ArrayList<UnitsStatisticCorrectRateCondition>(_list114.size);
                  UnitsStatisticCorrectRateCondition _elem115;
                  for (int _i116 = 0; _i116 < _list114.size; ++_i116)
                  {
                    _elem115 = new UnitsStatisticCorrectRateCondition();
                    _elem115.read(iprot);
                    struct.unitsStatisticCorrectRateCondition.add(_elem115);
                  }
                  iprot.readListEnd();
                }
                struct.setUnitsStatisticCorrectRateConditionIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args struct) throws TException {
        ...
        if (struct.unitsStatisticCorrectRateCondition != null) {
          oprot.writeFieldBegin(UNITS_STATISTIC_CORRECT_RATE_CONDITION_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.unitsStatisticCorrectRateCondition.size()));
            for (UnitsStatisticCorrectRateCondition _iter117 : struct.unitsStatisticCorrectRateCondition)
            {
    ...
    private static class retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_argsTupleScheme extends TupleScheme<retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, retrieveQuizzesAndAssignmentsCorrectRateListByUnitIds_args struct) throws TException {
        ...
        if (struct.isSetUnitsStatisticCorrectRateCondition()) {
          {
            oprot.writeI32(struct.unitsStatisticCorrectRateCondition.size());
            for (UnitsStatisticCorrectRateCondition _iter118 : struct.unitsStatisticCorrectRateCondition)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.unitsStatisticCorrectRateCondition = new ArrayList<UnitsStatisticCorrectRateCondition>(_list119.size);
            UnitsStatisticCorrectRateCondition _elem120;
            for (int _i121 = 0; _i121 < _list119.size; ++_i121)
            {
              _elem120 = new UnitsStatisticCorrectRateCondition();
              _elem120.read(iprot);
              struct.unitsStatisticCorrectRateCondition.add(_elem120);
            }
          }
          struct.setUnitsStatisticCorrectRateConditionIsSet(true);
        }
