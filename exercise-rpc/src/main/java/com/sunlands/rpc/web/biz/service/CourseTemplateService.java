...
import com.sunlands.rpc.web.coursetemplate.service.TemplateUnitNodeInfoIntermediate;
...
public interface CourseTemplateService {
     ...
     * @param templateUnitIdList
     * @return
     */
    List<TemplateUnitNodeInfoIntermediate> retrieveCourseTemplateTeachUnitNodes(List<Integer> templateUnitIdList);
