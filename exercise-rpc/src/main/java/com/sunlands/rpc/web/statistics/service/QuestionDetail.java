...
public class QuestionDetail implements org.apache.thrift.TBase<QuestionDetail, QuestionDetail._Fields>, java.io.Serializable, Cloneable, Comparable<QuestionDetail> {
  ...
  private static class QuestionDetailStandardScheme extends StandardScheme<QuestionDetail> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, QuestionDetail struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.questionOptions = new ArrayList<Option>(_list24.size);
                Option _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new Option();
                  _elem25.read(iprot);
                  struct.questionOptions.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.optionAnswers = new ArrayList<OptionAnswer>(_list27.size);
                OptionAnswer _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new OptionAnswer();
                  _elem28.read(iprot);
                  struct.optionAnswers.add(_elem28);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.scorePoints = new ArrayList<ScorePoint>(_list30.size);
                ScorePoint _elem31;
                for (int _i32 = 0; _i32 < _list30.size; ++_i32)
                {
                  _elem31 = new ScorePoint();
                  _elem31.read(iprot);
                  struct.scorePoints.add(_elem31);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QuestionDetail struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.questionOptions != null) {
        oprot.writeFieldBegin(QUESTION_OPTIONS_FIELD_DESC);
        {
          ...
          for (Option _iter33 : struct.questionOptions)
          {
            _iter33.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.optionAnswers != null) {
        oprot.writeFieldBegin(OPTION_ANSWERS_FIELD_DESC);
        {
          ...
          for (OptionAnswer _iter34 : struct.optionAnswers)
          {
            _iter34.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.scorePoints != null) {
        oprot.writeFieldBegin(SCORE_POINTS_FIELD_DESC);
        {
          ...
          for (ScorePoint _iter35 : struct.scorePoints)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class QuestionDetailTupleScheme extends TupleScheme<QuestionDetail> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QuestionDetail struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetQuestionOptions()) {
        {
          ...
          for (Option _iter36 : struct.questionOptions)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (struct.isSetOptionAnswers()) {
        {
          ...
          for (OptionAnswer _iter37 : struct.optionAnswers)
          {
            _iter37.write(oprot);
          }
        }
      ...
      if (struct.isSetScorePoints()) {
        {
          ...
          for (ScorePoint _iter38 : struct.scorePoints)
          {
            _iter38.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QuestionDetail struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.questionOptions = new ArrayList<Option>(_list39.size);
          Option _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = new Option();
            _elem40.read(iprot);
            struct.questionOptions.add(_elem40);
          }
        }
        struct.setQuestionOptionsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.optionAnswers = new ArrayList<OptionAnswer>(_list42.size);
          OptionAnswer _elem43;
          for (int _i44 = 0; _i44 < _list42.size; ++_i44)
          {
            _elem43 = new OptionAnswer();
            _elem43.read(iprot);
            struct.optionAnswers.add(_elem43);
          }
        }
        struct.setOptionAnswersIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.scorePoints = new ArrayList<ScorePoint>(_list45.size);
          ScorePoint _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new ScorePoint();
            _elem46.read(iprot);
            struct.scorePoints.add(_elem46);
          }
        }
        struct.setScorePointsIsSet(true);
      }
