...
public class WebCourseTemplateService {
  ...
  public interface AsyncIface {
    ...
    public void retrieveCourseTemplateInfoById(int courseTemplateId, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_retrieveCourseTemplateInfoById(int courseTemplateId) throws TException
    {
    ...
    public List<List<UnitNodeInfo>> recv_retrieveCourseTemplateInfoById() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class retrieveCourseTemplateInfoById_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int courseTemplateId;
      public retrieveCourseTemplateInfoById_call(int courseTemplateId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.courseTemplateId = courseTemplateId;
      }
      ...
      public List<List<UnitNodeInfo>> getResult() throws TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class retrieveCourseTemplateInfoById<I extends Iface> extends org.apache.thrift.ProcessFunction<I, retrieveCourseTemplateInfoById_args> {
      ...
      public retrieveCourseTemplateInfoById_result getResult(I iface, retrieveCourseTemplateInfoById_args args) throws TException {
        retrieveCourseTemplateInfoById_result result = new retrieveCourseTemplateInfoById_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class retrieveCourseTemplateInfoById<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, retrieveCourseTemplateInfoById_args, List<List<UnitNodeInfo>>> {
      ...
      public void start(I iface, retrieveCourseTemplateInfoById_args args, AsyncMethodCallback<List<List<UnitNodeInfo>>> resultHandler) throws TException {
  ...
  public static class retrieveCourseTemplateInfoById_args implements org.apache.thrift.TBase<retrieveCourseTemplateInfoById_args, retrieveCourseTemplateInfoById_args._Fields>, java.io.Serializable, Cloneable, Comparable<retrieveCourseTemplateInfoById_args>   {
    ...
    private static class retrieveCourseTemplateInfoById_argsStandardScheme extends StandardScheme<retrieveCourseTemplateInfoById_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, retrieveCourseTemplateInfoById_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, retrieveCourseTemplateInfoById_args struct) throws TException {
        struct.validate();
    ...
    private static class retrieveCourseTemplateInfoById_argsTupleScheme extends TupleScheme<retrieveCourseTemplateInfoById_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, retrieveCourseTemplateInfoById_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetCourseTemplateId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, retrieveCourseTemplateInfoById_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.courseTemplateId = iprot.readI32();
  ...
  public static class retrieveCourseTemplateInfoById_result implements org.apache.thrift.TBase<retrieveCourseTemplateInfoById_result, retrieveCourseTemplateInfoById_result._Fields>, java.io.Serializable, Cloneable, Comparable<retrieveCourseTemplateInfoById_result>   {
    ...
    private static class retrieveCourseTemplateInfoById_resultStandardScheme extends StandardScheme<retrieveCourseTemplateInfoById_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, retrieveCourseTemplateInfoById_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<List<UnitNodeInfo>>(_list64.size);
                  List<UnitNodeInfo> _elem65;
                  for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                  {
                    {
                      org.apache.thrift.protocol.TList _list67 = iprot.readListBegin();
                      _elem65 = new ArrayList<UnitNodeInfo>(_list67.size);
                      UnitNodeInfo _elem68;
                      for (int _i69 = 0; _i69 < _list67.size; ++_i69)
                      {
                        _elem68 = new UnitNodeInfo();
                        _elem68.read(iprot);
                        _elem65.add(_elem68);
                      }
                      iprot.readListEnd();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, retrieveCourseTemplateInfoById_result struct) throws TException {
        struct.validate();
    ...
    private static class retrieveCourseTemplateInfoById_resultTupleScheme extends TupleScheme<retrieveCourseTemplateInfoById_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, retrieveCourseTemplateInfoById_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (List<UnitNodeInfo> _iter72 : struct.success)
            {
              {
                oprot.writeI32(_iter72.size());
                for (UnitNodeInfo _iter73 : _iter72)
                {
                  _iter73.write(oprot);
                }
              }
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, retrieveCourseTemplateInfoById_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<List<UnitNodeInfo>>(_list74.size);
            List<UnitNodeInfo> _elem75;
            for (int _i76 = 0; _i76 < _list74.size; ++_i76)
            {
              {
                org.apache.thrift.protocol.TList _list77 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
                _elem75 = new ArrayList<UnitNodeInfo>(_list77.size);
                UnitNodeInfo _elem78;
                for (int _i79 = 0; _i79 < _list77.size; ++_i79)
                {
                  _elem78 = new UnitNodeInfo();
                  _elem78.read(iprot);
                  _elem75.add(_elem78);
                }
              }
