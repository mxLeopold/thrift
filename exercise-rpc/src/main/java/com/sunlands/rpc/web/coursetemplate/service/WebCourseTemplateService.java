              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<KnowledgeTree>(_list48.size);
                  KnowledgeTree _elem49;
                  for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                  {
                    _elem49 = new KnowledgeTree();
                    _elem49.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCourseTemplateKnowledgeTreeListBySubjectAndType_result struct) throws TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (KnowledgeTree _iter51 : struct.success)
            {
              _iter51.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (KnowledgeTree _iter52 : struct.success)
            {
              _iter52.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<KnowledgeTree>(_list53.size);
            KnowledgeTree _elem54;
            for (int _i55 = 0; _i55 < _list53.size; ++_i55)
            {
              _elem54 = new KnowledgeTree();
              _elem54.read(iprot);
    ...
    private static class getCourseTemplateListByCondition_resultStandardScheme extends StandardScheme<getCourseTemplateListByCondition_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CourseTemplate>(_list56.size);
                  CourseTemplate _elem57;
                  for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                  {
                    _elem57 = new CourseTemplate();
                    _elem57.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCourseTemplateListByCondition_result struct) throws TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (CourseTemplate _iter59 : struct.success)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getCourseTemplateListByCondition_resultTupleScheme extends TupleScheme<getCourseTemplateListByCondition_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getCourseTemplateListByCondition_result struct) throws TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (CourseTemplate _iter60 : struct.success)
            {
              _iter60.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CourseTemplate>(_list61.size);
            CourseTemplate _elem62;
            for (int _i63 = 0; _i63 < _list61.size; ++_i63)
            {
              _elem62 = new CourseTemplate();
              _elem62.read(iprot);
    ...
    private static class retrieveCourseTemplateTreeInfo_resultStandardScheme extends StandardScheme<retrieveCourseTemplateTreeInfo_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<LastKnowledgeNodeInfo>(_list64.size);
                  LastKnowledgeNodeInfo _elem65;
                  for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                  {
                    _elem65 = new LastKnowledgeNodeInfo();
                    _elem65.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, retrieveCourseTemplateTreeInfo_result struct) throws TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (LastKnowledgeNodeInfo _iter67 : struct.success)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class retrieveCourseTemplateTreeInfo_resultTupleScheme extends TupleScheme<retrieveCourseTemplateTreeInfo_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, retrieveCourseTemplateTreeInfo_result struct) throws TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (LastKnowledgeNodeInfo _iter68 : struct.success)
            {
              _iter68.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<LastKnowledgeNodeInfo>(_list69.size);
            LastKnowledgeNodeInfo _elem70;
            for (int _i71 = 0; _i71 < _list69.size; ++_i71)
            {
              _elem70 = new LastKnowledgeNodeInfo();
              _elem70.read(iprot);
