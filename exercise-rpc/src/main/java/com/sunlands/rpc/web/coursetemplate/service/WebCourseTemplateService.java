    ...
    private static class retrieveTemplateUnitNodeDetailInfo_resultStandardScheme extends StandardScheme<retrieveTemplateUnitNodeDetailInfo_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<TemplateUnitInfo>(_list88.size);
                  TemplateUnitInfo _elem89;
                  for (int _i90 = 0; _i90 < _list88.size; ++_i90)
                  {
                    _elem89 = new TemplateUnitInfo();
                    _elem89.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, retrieveTemplateUnitNodeDetailInfo_result struct) throws TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (TemplateUnitInfo _iter91 : struct.success)
            {
              _iter91.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class retrieveTemplateUnitNodeDetailInfo_resultTupleScheme extends TupleScheme<retrieveTemplateUnitNodeDetailInfo_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, retrieveTemplateUnitNodeDetailInfo_result struct) throws TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (TemplateUnitInfo _iter92 : struct.success)
            {
              _iter92.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<TemplateUnitInfo>(_list93.size);
            TemplateUnitInfo _elem94;
            for (int _i95 = 0; _i95 < _list93.size; ++_i95)
            {
              _elem94 = new TemplateUnitInfo();
              _elem94.read(iprot);
