            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ranking = new ArrayList<StuAnswerDetail>(_list16.size);
                StuAnswerDetail _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new StuAnswerDetail();
                  _elem17.read(iprot);
                  struct.ranking.add(_elem17);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.questionDetailList = new ArrayList<QuestionDetail>(_list19.size);
                QuestionDetail _elem20;
                for (int _i21 = 0; _i21 < _list19.size; ++_i21)
                {
                  _elem20 = new QuestionDetail();
                  _elem20.read(iprot);
                  struct.questionDetailList.add(_elem20);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PaperDetail struct) throws TException {
      ...
      if (struct.ranking != null) {
        oprot.writeFieldBegin(RANKING_FIELD_DESC);
        {
          ...
          for (StuAnswerDetail _iter22 : struct.ranking)
          {
            _iter22.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.questionDetailList != null) {
        oprot.writeFieldBegin(QUESTION_DETAIL_LIST_FIELD_DESC);
        {
          ...
          for (QuestionDetail _iter23 : struct.questionDetailList)
          {
            _iter23.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetRanking()) {
        {
          ...
          for (StuAnswerDetail _iter24 : struct.ranking)
          {
            _iter24.write(oprot);
          }
        }
      ...
      if (struct.isSetQuestionDetailList()) {
        {
          ...
          for (QuestionDetail _iter25 : struct.questionDetailList)
          {
            _iter25.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.ranking = new ArrayList<StuAnswerDetail>(_list26.size);
          StuAnswerDetail _elem27;
          for (int _i28 = 0; _i28 < _list26.size; ++_i28)
          {
            _elem27 = new StuAnswerDetail();
            _elem27.read(iprot);
            struct.ranking.add(_elem27);
          }
        }
        struct.setRankingIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.questionDetailList = new ArrayList<QuestionDetail>(_list29.size);
          QuestionDetail _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new QuestionDetail();
            _elem30.read(iprot);
            struct.questionDetailList.add(_elem30);
          }
        }
        struct.setQuestionDetailListIsSet(true);
      }
