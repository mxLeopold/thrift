            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.questions = new ArrayList<QuestionDetail>(_list16.size);
                QuestionDetail _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new QuestionDetail();
                  _elem17.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.quizzesOrWorkUserAnswersDTOList = new ArrayList<QuizzesOrWorkUserAnswers>(_list19.size);
                QuizzesOrWorkUserAnswers _elem20;
                for (int _i21 = 0; _i21 < _list19.size; ++_i21)
                {
                  _elem20 = new QuizzesOrWorkUserAnswers();
                  _elem20.read(iprot);
                  struct.quizzesOrWorkUserAnswersDTOList.add(_elem20);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PaperDetail struct) throws TException {
      ...
      if (struct.questions != null) {
        oprot.writeFieldBegin(QUESTIONS_FIELD_DESC);
        {
          ...
          for (QuestionDetail _iter22 : struct.questions)
          {
            _iter22.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.quizzesOrWorkUserAnswersDTOList != null) {
        oprot.writeFieldBegin(QUIZZES_OR_WORK_USER_ANSWERS_DTOLIST_FIELD_DESC);
        {
          ...
          for (QuizzesOrWorkUserAnswers _iter23 : struct.quizzesOrWorkUserAnswersDTOList)
          {
            _iter23.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetQuestions()) {
        {
          ...
          for (QuestionDetail _iter24 : struct.questions)
          {
            _iter24.write(oprot);
          }
        }
      ...
      if (struct.isSetQuizzesOrWorkUserAnswersDTOList()) {
        {
          ...
          for (QuizzesOrWorkUserAnswers _iter25 : struct.quizzesOrWorkUserAnswersDTOList)
          {
            _iter25.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.questions = new ArrayList<QuestionDetail>(_list26.size);
          QuestionDetail _elem27;
          for (int _i28 = 0; _i28 < _list26.size; ++_i28)
          {
            _elem27 = new QuestionDetail();
            _elem27.read(iprot);
            struct.questions.add(_elem27);
          }
        }
        struct.setQuestionsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.quizzesOrWorkUserAnswersDTOList = new ArrayList<QuizzesOrWorkUserAnswers>(_list29.size);
          QuizzesOrWorkUserAnswers _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new QuizzesOrWorkUserAnswers();
            _elem30.read(iprot);
            struct.quizzesOrWorkUserAnswersDTOList.add(_elem30);
          }
        }
        struct.setQuizzesOrWorkUserAnswersDTOListIsSet(true);
      }
