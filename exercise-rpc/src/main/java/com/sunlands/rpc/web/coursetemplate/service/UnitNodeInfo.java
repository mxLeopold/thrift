            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.knowledgeNodeList = new ArrayList<UnitNodeInfo>(_list40.size);
                UnitNodeInfo _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new UnitNodeInfo();
                  _elem41.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UnitNodeInfo struct) throws TException {
      ...
      if (struct.knowledgeNodeList != null) {
        oprot.writeFieldBegin(KNOWLEDGE_NODE_LIST_FIELD_DESC);
        {
          ...
          for (UnitNodeInfo _iter43 : struct.knowledgeNodeList)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetKnowledgeNodeList()) {
        {
          ...
          for (UnitNodeInfo _iter44 : struct.knowledgeNodeList)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.knowledgeNodeList = new ArrayList<UnitNodeInfo>(_list45.size);
          UnitNodeInfo _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new UnitNodeInfo();
            _elem46.read(iprot);
