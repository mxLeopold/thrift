...
public class DailyExerciseSubject implements org.apache.thrift.TBase<DailyExerciseSubject, DailyExerciseSubject._Fields>, java.io.Serializable, Cloneable, Comparable<DailyExerciseSubject> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DailyExerciseSubject");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DailyExerciseSubjectStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DailyExerciseSubjectTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DailyExerciseSubject.class, metaDataMap);
  }

  public DailyExerciseSubject() {
  }
   ...
   */
  public DailyExerciseSubject(DailyExerciseSubject other) {
  ...
  public DailyExerciseSubject deepCopy() {
    return new DailyExerciseSubject(this);
  }
  ...
  public DailyExerciseSubject setSubjectId(int subjectId) {
    this.subjectId = subjectId;
    setSubjectIdIsSet(true);
    return this;
  }
  ...
  public DailyExerciseSubject setSubjectName(String subjectName) {
    this.subjectName = subjectName;
    return this;
  }
  ...
  public DailyExerciseSubject setHasPassedUnitNum(int hasPassedUnitNum) {
    this.hasPassedUnitNum = hasPassedUnitNum;
    setHasPassedUnitNumIsSet(true);
    return this;
  }
  ...
  public void unsetHasPassedUnitNum() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __HASPASSEDUNITNUM_ISSET_ID);
  }
  ...
  public boolean isSetHasPassedUnitNum() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __HASPASSEDUNITNUM_ISSET_ID);
  }

  public void setHasPassedUnitNumIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __HASPASSEDUNITNUM_ISSET_ID, value);
  }
  ...
  public DailyExerciseSubject setTotalUnitNum(int totalUnitNum) {
    this.totalUnitNum = totalUnitNum;
    setTotalUnitNumIsSet(true);
    return this;
  }
  ...
  public void unsetTotalUnitNum() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __TOTALUNITNUM_ISSET_ID);
  }

  /** Returns true if field totalUnitNum is set (has been assigned a value) and false otherwise */
  public boolean isSetTotalUnitNum() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __TOTALUNITNUM_ISSET_ID);
  }

  public void setTotalUnitNumIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __TOTALUNITNUM_ISSET_ID, value);
  }
  ...
  public DailyExerciseSubject setModuleType(String moduleType) {
    this.moduleType = moduleType;
    return this;
  }
  ...
  public DailyExerciseSubject setProvinceId(int provinceId) {
    this.provinceId = provinceId;
    setProvinceIdIsSet(true);
    return this;
  }
  ...
  public DailyExerciseSubject setProjectSecondId(int projectSecondId) {
    this.projectSecondId = projectSecondId;
    setProjectSecondIdIsSet(true);
    return this;
  }
  ...
  public void unsetProjectSecondId() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __PROJECTSECONDID_ISSET_ID);
  }
  ...
  public boolean isSetProjectSecondId() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __PROJECTSECONDID_ISSET_ID);
  }

  public void setProjectSecondIdIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __PROJECTSECONDID_ISSET_ID, value);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DailyExerciseSubject)
      return this.equals((DailyExerciseSubject)that);
    return false;
  }

  public boolean equals(DailyExerciseSubject that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + hasPassedUnitNum;

    hashCode = hashCode * 8191 + totalUnitNum;

    hashCode = hashCode * 8191 + ((isSetModuleType()) ? 131071 : 524287);
    if (isSetModuleType())
      hashCode = hashCode * 8191 + moduleType.hashCode();

    hashCode = hashCode * 8191 + provinceId;

    hashCode = hashCode * 8191 + projectSecondId;

    return hashCode;
  }

  @Override
  public int compareTo(DailyExerciseSubject other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DailyExerciseSubject(");
    boolean first = true;
  ...
  private static class DailyExerciseSubjectStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DailyExerciseSubjectStandardScheme getScheme() {
      return new DailyExerciseSubjectStandardScheme();
    }
  }

  private static class DailyExerciseSubjectStandardScheme extends org.apache.thrift.scheme.StandardScheme<DailyExerciseSubject> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DailyExerciseSubject struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DailyExerciseSubject struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DailyExerciseSubjectTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DailyExerciseSubjectTupleScheme getScheme() {
      return new DailyExerciseSubjectTupleScheme();
    }
  }

  private static class DailyExerciseSubjectTupleScheme extends org.apache.thrift.scheme.TupleScheme<DailyExerciseSubject> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DailyExerciseSubject struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DailyExerciseSubject struct) throws org.apache.thrift.TException {
