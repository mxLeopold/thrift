...
public class StuRound implements org.apache.thrift.TBase<StuRound, StuRound._Fields>, java.io.Serializable, Cloneable, Comparable<StuRound> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StuRound");
  ...
  static {
    schemes.put(StandardScheme.class, new StuRoundStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StuRoundTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StuRound.class, metaDataMap);
  }
   ...
   */
  public StuRound(StuRound other) {
    __isset_bitfield = other.__isset_bitfield;
    this.roundId = other.roundId;
    this.stuId = other.stuId;
  }

  public StuRound deepCopy() {
    return new StuRound(this);
  }
  ...
  public StuRound setRoundId(int roundId) {
    this.roundId = roundId;
    setRoundIdIsSet(true);
    return this;
  }
  ...
  public StuRound setStuId(int stuId) {
    this.stuId = stuId;
    setStuIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StuRound)
      return this.equals((StuRound)that);
    return false;
  }

  public boolean equals(StuRound that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StuRound other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StuRound(");
    boolean first = true;
  ...
  private static class StuRoundStandardSchemeFactory implements SchemeFactory {
    public StuRoundStandardScheme getScheme() {
      return new StuRoundStandardScheme();
    }
  }

  private static class StuRoundStandardScheme extends StandardScheme<StuRound> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StuRound struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StuRound struct) throws TException {
      struct.validate();
  ...
  private static class StuRoundTupleSchemeFactory implements SchemeFactory {
    public StuRoundTupleScheme getScheme() {
      return new StuRoundTupleScheme();
    }
  }

  private static class StuRoundTupleScheme extends TupleScheme<StuRound> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StuRound struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StuRound struct) throws TException {
